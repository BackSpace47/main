...
public class RPREBTree extends WorldGenAbstractTree{
    ...
    public RPREBTree(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public RPREBTree(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
            ...
            else
            {
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                        ...
                        for (i2 = par3 - l1; i2 <= par3 + l1; ++i2)
                        {
                            ...
                            for (int k2 = par5 - l1; k2 <= par5 + l1; ++k2)
                            {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || par2Random.nextInt(2) != 0 && i3 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndNotifyAdequately(par1World, i2, k1, k2, RPCore.elderLeaf, this.metaLeaves);
                                    }
                                }
                            }
                        }
                    ...
                    for (k1 = 0; k1 < l; ++k1)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(par1World, par3, par4 + k1, par5, RPCore.elderLog, this.metaWood);
