...
import net.RPower.RPowermod.entity.EntityJadeTNTPrimed;
...
public class BlockJadeBomb extends Block {

	public BlockJadeBomb(Material p_i45394_1_) {
		super(p_i45394_1_);
	}
	/**
    ...
    public void onBlockDestroyedByExplosion(World p_149723_1_, int p_149723_2_, int p_149723_3_, int p_149723_4_, Explosion p_149723_5_)
    {
        ...
        {
            EntityJadeTNTPrimed entitytntprimed = new EntityJadeTNTPrimed(p_149723_1_, (double)((float)p_149723_2_ + 0.5F), (double)((float)p_149723_3_ + 0.5F), (double)((float)p_149723_4_ + 0.5F), p_149723_5_.getExplosivePlacedBy());
    ...
    {
        if (p_150114_1_.isRemote != false)
        {
                EntityJadeTNTPrimed entitytntprimed = new EntityJadeTNTPrimed(p_150114_1_, (double)((float)p_150114_2_ + 0.5F), (double)((float)p_150114_3_ + 0.5F), (double)((float)p_150114_4_ + 0.5F), p_150114_6_);
